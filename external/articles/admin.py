...
class ArticleAdmin(admin.ModelAdmin):
    list_display = ('title', 'status', 'author', 'language', 'publish_date', 'expiration_date', 'is_active')
    list_filter = ('author', 'status', 'is_active', 'publish_date', 'expiration_date', 'sites')
    list_per_page = 25
    search_fields = ('title', 'keywords', 'language', 'description', 'content')
    ...
    fieldsets = (
        (None, {'fields': ('title', 'content', 'language', 'tags', 'auto_tag', 'markup', 'status')}),
        ('Metadata', {
